    ...
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      <section className="container mx-auto flex flex-col md:flex-row items-center justify-between py-0 px-4">
        ...
        <div className="w-full md:w-1/2 mb-8 md:mb-0 ml-10 mr--20 font-['Arial']">
          <h1
            className="text-7xl md:text-8xl font-semibold text-yellow-400 mb-6"
            style={{ fontSize: "93px" }}
          >
            Creative
            <br />
          ...
          <p className="text-lg mb-8 max-w-md font-['Inter']">
            Use our project management software to transform your company and
            manage business operations more smoothly and effectively.
          </p>
          <a href="/company-login">
            <button className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-3 px-6 rounded-md flex items-center font-[';'] hover:cursor-pointer">
              Get Started
              <svg
        ...
        <div className="w-[110%] md:w-1/2 relative mr-10">
          <div className="flex items-center justify-center">
            <img
              src={beesrc}
              alt="Server racks with cartoon robots"
              className="w-[120%] h-[120%] my--15"
            />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-8">
            <img
              src={ebay}
              alt="eBay logo"
              className=" mr-18 h-13 opacity-70 w-20"
            />
            <img
              src={cisco}
              alt="Cisco logo"
      ...
      <div className="bg-gray-800 rounded-xl p-8 max-w-4xl mx-auto my-16">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto font-['Inter']">
            Transform how your team works with our powerful project management
            tools. Choose the plan that fits your business needs.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900 rounded-lg p-6 flex flex-col">
            ...
            <div className="text-yellow-400 text-4xl font-bold mb-4 font-['Inter']">
          ...
          <div className="bg-yellow-400 rounded-lg p-6 flex flex-col relative transform scale-105">
            <div className="absolute -top-4 left-0 right-0 text-center">
              <span className="bg-blue-600 text-white text-sm py-1 px-3 rounded-full font-['Inter']">
                MOST POPULAR
              </span>
            </div>
            ...
            <div className="text-gray-900 text-4xl font-bold mb-4 font-['Inter']">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-400 mb-6 font-['Inter']">
              Stay updated with the latest features, tips, and project
              management insights.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div>
              <h4 className="text-white font-bold mb-4 font-['Inter']">
                Product
              </h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#"
                    className="text-gray-400 hover:text-yellow-400 transition-colors font-['Inter']"
                  >
                    Features
                  </a>
                </li>
          ...
          <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-4 md:mb-0">
              ...
              <span className="text-gray-400 font-['Inter']">
                © 2025 Creative Plan. All rights reserved.
              </span>
            </div>
